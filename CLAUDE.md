...
errors (`diag::csharp_unmarshallable`) for what later phases add: maps,
smart pointers, variant, array-of-welded, nested types. Driven by `welder_csharp_generate_bindings()`
