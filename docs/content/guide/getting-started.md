...
## Building welder's own examples & tests

Consuming welder needs no Conan — but building welder's *own* examples and tests
from a clone does: Conan provisions the backends, then the preset configures and
builds:
