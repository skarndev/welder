...
// header is pulled into the module interface unit, src/welder/welder.cppm defines
...
// and backends (`<welder/backends/pybind11.hpp>`) depend on <meta> and pybind11, which pull
